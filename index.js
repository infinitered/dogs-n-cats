...
export class DogsNCats {
  ...
  async load() {
    ...
    this.shuffledDogIndices = tf.util.createShuffledIndices(NUM_DATASET_ELEMENTS)
    ...
    this.shuffledTrainIndices = tf.util.createShuffledIndices(NUM_TRAIN_ELEMENTS * NUM_CLASSES)
    ...
    this.shuffledTestIndices = tf.util.createShuffledIndices(NUM_TEST_ELEMENTS * NUM_CLASSES)
